...
Серверная агентная основа: [Агент хранения профилей](src/Dreamsleeve.Server.Core/README.ru.md).
Команды хранения и ответы проходят через mailbox; агент в памяти находится в Infrastructure.
