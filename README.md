...
Серверная агентная основа: [Профили, каналы и сессии](src/Dreamsleeve.Server.Core/README.ru.md).
...
SessionRegistry связывает профиль и вход в канал, формирует начальное состояние
и уведомления онлайна. SendChat и подключение этих агентов к ENet ещё предстоят.
