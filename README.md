...
клиентские хранилища игроков и чата, `ClientModel`, публикация снимков и `ChangeBatch`
с дельтами содержимого чата. Прикладной протокол, серверный цикл приложения,
