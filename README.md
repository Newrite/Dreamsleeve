...
Серверная агентная основа: [Профили и каналы чата](src/Dreamsleeve.Server.Core/README.ru.md).
...
Реестр сессий и подключение этих агентов к ENet пока не реализованы.
