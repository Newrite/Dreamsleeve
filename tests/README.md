...
| `Dreamsleeve.Server.Tests` | Expecto + Faqt, F# executable | Dreamsleeve.Server.Domain (41), Dreamsleeve.Agent (28), Dreamsleeve.Server.Codec (12), Background (9), Profiles (9) |
...
восстановление без потери отказов и двусторонний обмен с join владельца. F#: 99 сценариев.
...
Проверено на Windows/MSVC/.NET 10: 152/152 native (1991 assertions) и 99/99 managed.
...
Managed-набор теперь содержит 99 тестов: прежние 81 и 18 новых сценариев
Background/Profiles. Проверяются отзывчивость mailbox во время I/O, возврат
